...
- [二、提高部分](#二、提高部分)
    - [1、SQL 优化](#1、SQL优化)
    - [2、MySQL 高效分页](#2、MySQL高效分页)
- [三、事务](#三、事务)
    - [1、事务的特性 / ACID](#1、事务的特性/ACID)
    - [2、事务的隔离级别](#2、事务的隔离级别)
    - [3、幻读 / Phantom Read](#3、幻读/Phantom Read)
    - [4、MVCC 的快照读和当前读](#4、MVCC的快照读和当前读)
    - [5、MySQL 的 InnoDB 如何实现 MVCC](#5、MySQL的InnoDB如何实现MVCC)
    - [6、MySQL 如何实现原子性](#6、MySQL如何实现原子性)
    - [7、MySQL 如何实现持久性](#7、MySQL如何实现持久性)
    - [8、MySQL 如何实现隔离性](#8、MySQL如何实现隔离性)
    - [9、MySQL 如何实现一致性](#9、MySQL如何实现一致性)
- [四、日志](#四、日志)
    - [1、MySQL 的日志](#1、MySQL的日志)
    - [2、redo log 与 binlog 的区别](#2、redo log与binlog的区别)
- [五、锁](#五、锁)
    - [1、锁的作用范围分类](#1、锁的作用范围分类)
    - [2、锁的模式分类](#2、锁的模式分类)
    - [3、InnoDB 中的行锁](#3、InnoDB中的行锁)
    - [4、锁组合](#4、锁组合)
    - [5、悲观锁和乐观锁](#5、悲观锁和乐观锁)
- [六、索引](#六、索引)
    - [1、MySQL 为什么需要索引](#1、MySQL为什么需要索引)
    - [2、MySQL 的索引分类](#2、MySQL的索引分类)
    - [3、联合索引 / 组合索引 / 复合索引](#3、联合索引/组合索引/复合索引)
    - [4、前缀索引](#4、前缀索引)
    - [5、覆盖索引](#5、覆盖索引)
    - [6、索引下推](#6、索引下推)
    - [7、聚簇索引、非聚簇索引的区别](#7、聚簇索引、非聚簇索引的区别)
    - [8、主键索引、非主键索引的区别](#8、主键索引、非主键索引的区别)
    - [9、InnoDB 中的 B+Tree 索引](#9、InnoDB中的B+Tree索引)
    - [10、B 树、B+ 树的区别](#10、B树、B+树的区别)
    - [11、hash 索引、B+ 树索引的区别](#11、hash索引、B+树索引的区别)
    - [12、有那些解决 hash 冲突的方法](#12、有那些解决hash冲突的方法)
