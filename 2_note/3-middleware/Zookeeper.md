...
- 默认总是最小的子节点对应的线程获得锁，释放锁时删除对应子节点便可
    - 死锁风险：
        - 方案一也存在这个问题，但方案二可以利用 ZK 的临时顺序节点来解决这个问题。
...
- [分布式系统协议 Paxos、Raft 和 ZAB](https://zhuanlan.zhihu.com/p/147691282)
- [带你彻底认识 Paxos 算法、Zab 协议和 Raft 协议的原理和本质](https://xie.infoq.cn/article/c8b1db19b9ec6dbb0b9764c3e)
- []()
- []()
- []()
