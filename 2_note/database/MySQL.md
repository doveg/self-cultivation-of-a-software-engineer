...
- [三、索引](#索引)
    ...
    - [02、索引的分类：主键、唯一、普通索引、全文索引](#索引的分类)
...
- [四、事务](#事务)
    ...
    - [03、**幻读** / Phantom Read](#幻读-/-Phantom-Read（重点）)
    - [04、MVCC 的实现原理](#MVCC-的实现原理)
    - [05、**快照读和当前读**](#快照读和当前读（重点）)
    - [06、MySQL 的 InnoDB 如何实现 MVCC：事务的版本号](#MySQL-的-InnoDB-如何实现-MVCC)
    - [07、MySQL 如何实现原子性：undo log](#MySQL-如何实现原子性)
    - [08、MySQL 如何实现持久性：redo log](#MySQL-如何实现持久性)
    - [09、MySQL 如何实现隔离性：锁机制](#MySQL-如何实现隔离性)
    - [10、MySQL 如何实现一致性：数据库层面、应用层面](#MySQL-如何实现一致性)
- [五、日志](#日志)
