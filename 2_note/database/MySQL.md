...
- [二、提高部分](#提高部分)
    - [01、SQL 优化](#SQL-优化)
    - [02、MySQL 高效分页](#MySQL-高效分页)
- [三、索引](#索引)
    - [01、MySQL 为什么需要索引](#MySQL-为什么需要索引)
    - [02、MySQL 的索引分类](#MySQL-的索引分类)
    - [03、联合索引 / 组合索引 / 复合索引](#联合索引-/-组合索引-/-复合索引)
    - [04、前缀索引](#前缀索引)
    - [05、覆盖索引](#覆盖索引)
    - [06、索引下推](#索引下推)
    - [07、聚簇索引、非聚簇索引的区别](#聚簇索引、非聚簇索引的区别)
    - [08、主键索引、非主键索引的区别](#主键索引、非主键索引的区别)
    ...
    - [15、如何做索引优化](#如何做索引优化)
- [四、事务](#事务)
    - [01、事务的特性 / ACID](#事务的特性-/-ACID)
    - [02、事务的隔离级别](#事务的隔离级别)
    - [03、幻读 / Phantom Read](#幻读-/-Phantom-Read)
    - [04、MVCC 的快照读和当前读](#MVCC-的快照读和当前读)
    - [05、MySQL 的 InnoDB 如何实现 MVCC](#MySQL-的-InnoDB-如何实现-MVCC)
    - [06、MySQL 如何实现原子性](#MySQL-如何实现原子性)
    - [07、MySQL 如何实现持久性](#MySQL-如何实现持久性)
    - [08、MySQL 如何实现隔离性](#MySQL-如何实现隔离性)
    - [09、MySQL 如何实现一致性](#MySQL-如何实现一致性)
- [五、日志](#日志)
    - [01、MySQL 的日志](#MySQL-的日志)
    - [02、redo log 与 binlog 的区别](#redo-log-与-binlog-的区别)
- [六、锁](#锁)
    - [01、锁的作用范围分类](#锁的作用范围分类)
    - [02、锁的模式分类](#锁的模式分类)
    - [03、InnoDB 中的行锁](#InnoDB-中的行锁)
    - [04、锁组合](#锁组合)
    - [05、悲观锁和乐观锁](#悲观锁和乐观锁)
...
范围查找很常用，款且 B+Tree 还支持排序，所以基本就不怎么用 hash 这种数据结构做索引了。
