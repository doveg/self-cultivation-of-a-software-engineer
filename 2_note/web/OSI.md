...
1. 物理层（Physical Layer）
    ...
    - 例如：针脚、电压、线缆规范、集线器、中继器、主机接口卡、调制解调器、无线电、**网卡**、**光纤**等
...
2. 数据链路层（Data Link Layer）
    ...
    - 例如：**交换机**、**以太网**、GPRS（通用分组无线服务）、令牌环、HDLC、帧中继、ISDN、ATM、IEEE 802.11、FDDI、PPP
...
3. 网络层（Network Layer）
    ...
    - 网络表头包含了网络资料
    - 例如：**路由**、**Wi-Fi（无线局域网）**、**网关**、**IP（互联网协议）**、**ICMP**、**ARP**
      、RARP、IPX、BGP、OSPF、RIP、IGRP、EIGRP、X.25
...
一个客户端连接的组成要素，它包括源 IP 地址、目标 IP 地址、源端口号、目标端口号
